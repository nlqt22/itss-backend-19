...
public class StaffController {
    ...
    public ResponseEntity<Page<PersonDTO>> findByOrganizationIdAndRoleSale(@RequestParam(value = "id") Integer organizationId, Pageable pageable) {
        return ResponseEntity.ok().body(personService.findByOrganizationIdAndRoleSale(organizationId, pageable));
    }

    @GetMapping(API.STAFFS + "/personal-trainer")
    public ResponseEntity<Page<PersonDTO>> findByOrganizationIdAndRolePT(@RequestParam(value = "id") Integer organizationId, Pageable pageable) {
        return ResponseEntity.ok().body(personService.findByOrganizationIdAndRolePT(organizationId, pageable));
    }
